import { PlayCircle, Plus, Sparkles, X } from 'lucide-react';
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='bg-blue-50 p-3 rounded-lg'>
                ...
                Add 8-12 relevant skills. Include both technical skills (programming languages and tools) and soft skills (leadership, communication).
                </p>
            </div>
        </div>
    )
